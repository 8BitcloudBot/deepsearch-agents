...
> Historical boundary: this document records the accepted Phase 9 portfolio
> release. The current schema `5.0.0` conversation product is described by
> [phase-status.md](../phase-status.md); older MySQL, task, PDF, and multi-source
> workspace statements below are retained only as Phase 9 evidence.
