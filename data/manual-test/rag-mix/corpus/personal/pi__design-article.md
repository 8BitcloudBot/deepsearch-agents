...
> 作者 Mario Zechner，2025-11-30。提取自 mariozechner.at 原文。
...
pi-ai and pi-agent-coreThere. Are. Four. Ligh... APIs
Context handoff
We live in a multi-model world
Structured split tool results
Minimal agent scaffold

pi-tuiTwo kinds of TUIs
Retained mode UI
Differential rendering

pi-coding-agentMinimal system prompt
Minimal toolset
YOLO by default
No built-in to-dos
No plan mode
